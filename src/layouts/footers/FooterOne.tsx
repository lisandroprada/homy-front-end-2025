...
import footerLogo_1 from '@/assets/images/logo/logo_propietas_01.svg';
            ...
            <div className='col-lg-4'>
              <div className={`footer-intro ${style ? 'position-relative z-1' : ''}`}>
                <div className='bg-wrapper'>
                  ...
                  <h6>CONTACT</h6>
                  <Link href='#' className={`email tran3s mb-70 lg-mb-50 ${style ? 'font-garamond' : 'fs-24 text-decoration-underline'}`}>
                    info@ipropietas.com.ar
                  </Link>
                  <ul className='style-none d-flex align-items-center social-icon'>
                    {icon_1.map((icon, i) => (
                      <li key={i}>
                        <Link href='#'>
                          <i className={`fa-brands fa${style ? '' : '-square'}-${icon}`}></i>
                        </Link>
                      </li>
                    ))}
                  </ul>
