          ...
          <div className='row'>
            <div className='col-lg-6 wow fadeInLeft'>
              <div className='mt-45'>
                ...
                <p className='fs-24 text-white pt-40 pb-30 md-pb-20 pe-xl-5'>xplorá una amplia selección de propiedades, incluyendo casas, departamentos, lotes y terrenos.</p>
