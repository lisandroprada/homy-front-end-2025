...
const footer_content: ContentType = {
  ...
  desc_2: 'Gregorio Mayo 106, Rawson, Chubut. Patagonia Argentina',
  email: 'info@ipropietas.com.ar',
  number: '+(54) 9 280-4503151',
      ...
      <div className='container container-large'>
        ...
        <div className='bottom-footer'>
          <div className='d-md-flex justify-content-center justify-content-md-between align-items-center'>
            ...
            <p className='mb-15 text-center text-lg-start order-md-first'>Derechos Reservados @2025 Propietas Inmobiliaria</p>
          </div>
        </div>
      </div>
    </div>
