...
import logo_4 from '@/assets/images/logo/logo_propietas_01.svg';
import logo_5 from '@/assets/images/logo/logo_propietas_02.svg';
import logo_6 from '@/assets/images/logo/logo_propietas_03.svg';
import logo_7 from '@/assets/images/logo/logo_propietas_04.svg';
                  ...
                  {!style_2 ? (
                    ...
                    <>
                      <li className='d-none d-md-flex align-items-center login-btn-one me-4 me-xxl-5'>
                        ...
                        <Link href='tel:(+54) 280-4503151' className='tran3s'>
                          +(54) 9 280-4503151
                        </Link>
                      </li>
                      <li>
