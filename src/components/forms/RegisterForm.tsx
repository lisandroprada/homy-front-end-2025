         ...
         <div className="row">
            <div className="col-12">
               <div className="input-group-meta position-relative mb-25">
                  <label>Name*</label>
                  <input type="text" {...register("name")} placeholder="Zubayer Hasan" autoComplete="name" />
            ...
            <div className="col-12">
               <div className="input-group-meta position-relative mb-20">
                  ...
                  <input type={isPasswordVisible ? "text" : "password"} {...register("password")} placeholder="Enter Password" className="pass_log_id" autoComplete="new-password" />
