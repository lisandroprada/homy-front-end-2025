          ...
          <div className='col-xl-8'>
            <div className='property-overview mb-50 bg-white shadow4 border-20 p-40'>
              ...
              <p className='fs-20 lh-lg'>
                Lorem ipsum dolor sit amet consectetur. Et velit varius ipsum tempor vel dignissim tincidunt. Aliquam accumsan laoreet ultricies tincidunt faucibus fames augue in sociis. Nisl enim
                integer neque nec.
              </p>
            </div>
