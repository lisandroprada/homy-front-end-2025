            ...
            <div className='col-xl-8'>
              <div className='property-overview bottom-line-dark pb-40 mb-60'>
                ...
                <p className='fs-20 lh-lg'>
                  Risk management and compliance, when approached strategically, have the potential to go beyond mitigating threats and protecting a company’s operations & reputation.They can actually
              ...
              <div className='review-form'>
                ...
                <p className='fs-20 lh-lg pb-15'>
                  <a onClick={() => setLoginModal(true)} style={{cursor: 'pointer'}} className='color-dark fw-500 text-decoration-underline'>
                    Ingresar
                  </a>
