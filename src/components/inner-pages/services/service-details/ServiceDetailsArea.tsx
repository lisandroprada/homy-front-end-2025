...
const content_data: ContentType = {
  ...
  desc_1: (
    <>
      Risk management and compliance, when approached strategically, have the potential to go beyond mitigating threats and protecting a company’s operations & reputation.They can actually generate
      value and create opportunities.
    </>
  ),
  desc_2: (
    <>
      Our dedicated risk and compliance consulting team assists clients in transforming uncertainty into advantageous prospects. We work collaboratively with organizations to identify & leverage the
      potential within their risk and compliance functions, enabling them to thrive in ever-changing business landscape.
    </>
  ),
        ...
        <div className='row'>
          <div className='col-lg-8'>
            <div className='service-post'>
              ...
              <Link href='/contact' className='btn-two mt-30'>
                Contactános
              </Link>
            </div>
          </div>
