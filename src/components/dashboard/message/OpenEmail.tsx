      ...
      <div className='open-email-container pb-40'>
        ...
        <div className='email-body divider'>
          <div className='ps-4 pe-4 ps-xxl-5 pe-xxl-5'>
            ...
            <p>After that we need to redesign our landing page because the current one doesn&apos;t carry any information. If you have any question don’t hesitate to Contactános.</p>
            <p>
              Our Telegram{' '}
          ...
          <div className='ps-4 pe-4 ps-xxl-5 pe-xxl-5'>
            <div className='attachments mb-30'>
              <div className='d-flex justify-content-between mb-5'>
                ...
                <Link href='#' className='all-download'>
                  Download All
                </Link>
              </div>
            ...
            <div className='compose-new-email-container'>
              <div className='new-email-header position-relative'>
                <div className='btn-group'>
                  <Link data-bs-toggle='collapse' href='#CC-input' role='button' aria-expanded='false' aria-controls='collapseExample'>
                    Cc
                  </Link>
                  <Link data-bs-toggle='collapse' href='#BCC-input' role='button' aria-expanded='false' aria-controls='collapseExample'>
                    Bcc
                  </Link>
                </div>
