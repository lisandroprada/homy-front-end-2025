          ...
          <div className='col-xl-3 col-sm-4'>
            <div className='input-box-one border-left'>
              ...
              <NiceSelect
                ...
                defaultCurrent={0}
                onChange={(option) => handlePriceDropChange(option.value)}
                name=''
                placeholder=''
              />
            </div>
          ...
          <div className='col-xxl-2 col-xl-1'>
            <div className='input-box-one lg-mt-20'>
              <div className='d-flex align-items-center justify-content-center justify-content-xl-end'>
                <Link href='#' data-bs-toggle='modal' data-bs-target='#advanceFilterModal' className='search-modal-btn tran3s text-uppercase fw-500 d-inline-flex align-items-center'>
