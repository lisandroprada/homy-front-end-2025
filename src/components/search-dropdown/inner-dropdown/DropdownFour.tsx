      ...
      <div className='inner-banner-two inner-banner z-1 pt-170 xl-pt-150 md-pt-130 pb-100 xl-pb-80 md-pb-50 position-relative' style={{backgroundImage: `url(/assets/images/media/img_49.jpg)`}}>
        <div className='container'>
          <div className='row'>
            <div className='col-lg-6'>
              <div className='title-one mb-30 md-mb-20'>
                <h3>
                  Find Your{' '}
                  <span>
                    Home <Image src={titleShape} alt='' className='lazy-img' />
                  </span>
                </h3>
              </div>
            ...
            <div className='col-lg-6'>
              <p className='sub-heading'>Más de 1.500 clientes, 600 propiedades administradas</p>
            </div>
          </div>
            ...
            <nav className='search-filter-nav-one d-flex'>
              <div className='nav nav-tabs border-0' role='tablist'>
                {tab_title.map((tab, index) => (
                  <button key={index} onClick={() => handleTabClick(index)} className={`nav-link m0 ${activeTab === index ? 'active' : ''}`} id='buy-tab' type='button'>
                    {tab}
                  </button>
                ))}
              </div>
