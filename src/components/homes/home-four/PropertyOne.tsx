                  ...
                  <div className='listing-card-one style-two shadow-none h-100 w-100'>
                      ...
                      <div className='position-relative overflow-hidden'>
                        ...
                        <div id={`carousel${item.carousel}`} className='carousel slide'>
                          <div className='carousel-indicators'>
                            <button type='button' data-bs-target={`#carousel${item.carousel}`} data-bs-slide-to='0' className='active' aria-current='true' aria-label='Diapositiva 1'></button>
                            <button type='button' data-bs-target={`#carousel${item.carousel}`} data-bs-slide-to='1' aria-label='Diapositiva 2'></button>
                            <button type='button' data-bs-target={`#carousel${item.carousel}`} data-bs-slide-to='2' aria-label='Diapositiva 3'></button>
                          </div>
                    ...
                    <div className='property-info pt-20'>
                      ...
                      <div className='pl-footer top-border bottom-border d-flex align-items-center justify-content-between'>
                        ...
                        <Link href='/listing_details_03' className='btn-four'>
