...
const HeroBanner = () => {
  ...
  return (
    <>
            ...
            <div className='row'>
              <div className='col-xxl-9 col-xl-8 col-lg-9 col-md-10'>
                ...
                <div className='d-inline-flex align-items-center flex-wrap'>
                  <Link href='/listing_03' className='btn-seven mb-20 me-4 me-xxl5'>
                    <span>Explorar todos listing</span> <i className='bi bi-arrow-up-right'></i>
                  </Link>
      ...
      {/* video modal start */}
      <VideoPopup isVideoOpen={isVideoOpen} setIsVideoOpen={setIsVideoOpen} videoId={'tUP5S4YdEJo'} />
      {/* video modal end */}
    </>
  );
};
